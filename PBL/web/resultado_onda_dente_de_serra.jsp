...
<body>
    ...
    <main class="container mt-4">
        ...
        <script>
            ...
            // Função para gerar a onda dente de serra
            function ondaDenteSerra(t, periodo) {
                return 2 * (t / periodo - Math.floor(0.5 + t / periodo));
            }

            // Gerar os dados da onda dente de serra
            const t = [];
            const onda = [];
            for (let i = t_i; i <= t_f; i += passo) {
                t.push(i);
                onda.push(ondaDenteSerra(i, periodo));
            }
            ...
            const trace = {
                ...
                y: onda,
                mode: 'lines',
                name: 'Onda Dente de Serra'
            };

            const data = [trace];
            const layout = {
                title: 'Sinal emitido (Onda Dente de Serra)',
                xaxis: { title: 'Tempo (s)' },
