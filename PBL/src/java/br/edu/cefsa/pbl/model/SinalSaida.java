...
public class SinalSaida {
    ...
    public static void ondaQuadrada(int N, double f0,
            double frequenciaCorte0,
    ...
    public static void ondaDenteSerra(int N, double f0,
            double frequenciaCorte0,
            double[] vetor_An_sinal_de_saida, double[] vetor_phi_n_sinal_de_saida) {
    ...
    public static void ondaTriangular(int N, double f0,
            double frequenciaCorte0,
            double[] vetor_An_sinal_de_saida, double[] vetor_phi_n_sinal_de_saida) {
    ...
    public static void ondaSenoidalRetificada(int N, double f0,
            double frequenciaCorte0,
            double[] vetor_An_sinal_de_saida, double[] vetor_phi_n_sinal_de_saida) {
